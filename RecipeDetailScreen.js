    ...
    return ( 
        <ScrollView>
            ...
            <View className='w-full absolute flex-row justify-between items center pt-14'>
                <TouchableOpacity onPress={()=> navigation.goBack()} className="p-2 rouneded full ml-5 bg-white">
                    <ChevronLeftIcon size={hp(3.5)} strokeWidth={4.5} color="#fbbf24" />
                </TouchableOpacity>
                <TouchableOpacity onPress={()=> setIsFavorite(!isFavorite)} className="p-2 rouneded full mr-5 bg-white">
            ...
            {/* meal description */}
                ...
                loading? (
                    ...
                    <View className="px-4 flex justify-between space-y-4 pt-8">
                        ...
                        <View className="flex-row justify-around">
                            <View className="flex rounded full bg-amber-300 p-2">
                                <View 
                                    stlye={{height: hp(6.5), width: hp(6.5)}}
                    ...
                    <View className="space-y-4">
                        <Text style={{fontSize: hp(1.5)}} className="font-bold flex-1 netural-700">
                            Ingridients
                        </Text>
                    ...
                    <View className="space-y-4">
                        ...
                        <Text style={{fontSize: hp(1.6)}} className="text-neureal-700">
                            {
                    ...
                    {/* Recipe Video*/}
                    {
                        isNumericLiteral.strYoutube && (
                            <View className= "space-y-4">
                                <Text style={{fontSize: hp(2.5)}} className="font-bold flex-1">
                                    Recipe Video 
                                </Text>
                                <View>
                                    <YoutubeIframe
